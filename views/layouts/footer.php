        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5">
                <ul class="list-unstyled list-inline social text-center">
                    ...
                    <li class="list-inline-item"><a href="https://www.instagram.com/lyubitel_meda/"><i class="fa fa-instagram"></i></a></li>
                    <li class="list-inline-item"><a href="https://vk.com/public196266468"><i class="fa fa-vk"></i></a></li>
                </ul>
            </div>
            <hr>
        </div>
